  ...
  if(cover_buf)
    {
      ...
      Gtk::ScrolledWindow *cover_scrl = Gtk::make_managed<
	  Gtk::ScrolledWindow>();
      ...
      else
	{
      ...
      cover->set_draw_func(
	  std::bind(&FullSizeCover::cover_draw, this,
...
void
FullSizeCover::cover_draw(const Cairo::RefPtr<Cairo::Context> &cr,
